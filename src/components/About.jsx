...
const About = () => {
  return (
    <div className="about-container" data-cy="about-page">
      ...
      <p data-cy="team-number" style={{ color: '#2563eb', fontWeight: '600', fontSize: '1.1rem' }}>
        Equipo 8
      </p>

      <p style={{ color: '#475569', lineHeight: '1.7', marginBottom: '2rem' }}>
        Somos un equipo de tres estudiantes comprometidos con el desarrollo de software de calidad. 
        ...
        La colaboración constante entre todos los miembros ha sido clave para superar los retos encontrados.
      </p>

      <div data-cy="team-member">
        <h3 data-cy="member-name">Raúl Llamas Yáñez</h3>
        <p data-cy="member-role">Desarrollador</p>
        <p data-cy="member-contribution">
      ...
      <div data-cy="team-member">
        <h3 data-cy="member-name">Oscar Martinez Moreno</h3>
        <p data-cy="member-role">Desarrollador</p>
        <p data-cy="member-contribution">
          Colaboró en la integración con la API, la resolución de errores y el trabajo conjunto 
          en las pruebas automatizadas con Cypress.
        </p>
      </div>

      <div data-cy="team-member">
        <h3 data-cy="member-name">Wendy Condor Saragosin</h3>
